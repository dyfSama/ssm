...
;layui.define(["table", "form"], function (e) {
    ...
    table.render({
        ...
        cols: [[
            ...
            {field: "ip", title: "IP"}, {field: "jointime", title: "加入时间", sort: !0},
        ...
        if ("del" === e.event) {
            ...
            layer.open({
                ...
                yes: function (e, t) {
                    ...
                    var r = "LAY-user-front-submit";
                    varn = t.find("iframe").contents().find("#" + r);
                    l.layui.form.on("submit(" + r + ")", function (t) {
                        t.field;
                        table.reload("LAY-user-front-submit"), layer.close(e)
                    }), n.trigger("click")
                },
