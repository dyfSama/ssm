$(function () {
    ...
    function c() {
        ...
        if (k) {
            //多添加一个index 刷新用
            var p = '<a href="javascript:;" class="active J_menuTab" index="'+m+'" data-id="' + o + '">' + l + ' <i class="fa fa-times-circle"></i></a>';
    ...
    $(".J_tabRefresh").on("click", function () {
        //使用index获取iframe
        var a = document.getElementsByClassName('active J_menuTab')[0].getAttribute('index');
        if(a === null){
            a = 0;
        }
        window.frames['iframe'+a].location.reload();
    });
