...
<head>
    ...
    <link href="${ctxStatic}/hplus/js/plugins/jquery-treegrid/jquery.treegrid.css" rel="stylesheet">
    <%-- nprogress --%>
    ...
    function treeTableInit(data) {
        $table.bootstrapTable({
            ...
            columns: [
                ...
                {field: 'parentId', title: '父级编号', width: 80, sortable: true, align: 'center'},
                {field: 'menuSort', title: '排序', width: 80, align: 'center'},
                {field: 'permission', title: '权限标识', align: 'center'},
                {field: 'url', title: '请求地址', align: 'center'},
                {field: 'menuType', title: '菜单类型', align: 'center', width: 70, formatter: 'typeFormatter'},
