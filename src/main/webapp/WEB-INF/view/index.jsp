...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/static/hplus/images/001.jpg" width="60px"/></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/a/index_v1" data-index="0">主页示例一</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/a/index_v2">主页示例二</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/user/findList2" >用户数据[layui]</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/user/findList">用户数据[bootstrap]</a>
                        </li>
                    </ul>

                </li>
                <li>
                    <a class="J_menuItem" href="empty_page.html"><i class="fa fa-columns"></i>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <!--
                    <li class="hidden-xs">
                        <a href="login_v2.html" class="J_menuItem">
                            <i class="fa fa-arrows-alt"></i> 退出
                        </a>
                    </li>-->
                </ul>
            </nav>
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/a/index_v1"
...
<script src="${pageContext.request.contextPath}/static/hplus/js/plugins/layer/layer.min.js" type="text/javascript"></script>
