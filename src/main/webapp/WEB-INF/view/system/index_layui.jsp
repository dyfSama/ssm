    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <img alt="image"
                         src="${pageContext.request.contextPath}/static/images/head/${currentUser.avatar}" width="35px"/>
                </li>
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <cite>dyfSama</cite>
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="component" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                           ...
                           <!-- <dd data-name="util">
                                <a lay-href="component/util/index.jsp">工具</a>
                            </dd>-->
                           <!-- <dd data-name="statue">
                                <a lay-href="component/statue/index.jsp">代码修饰</a>
                            </dd>-->
                        </dl>
                    </li>
                    ...
                    <li data-name="user" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a lay-href="${ctx}/user/findList2">用户列表_layui</a>
                            </dd>
                            <dd>
                                <a lay-href="${ctx}/user/findList">网站用户_bootstrap</a>
                            </dd>
                          <!--  <dd>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="${ctx}/console" lay-attr="${ctx}/console" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
                </ul>
            </div>
        </div>
