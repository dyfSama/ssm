...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layuiadmin/dist/layuiadmin/style/admin.css"
          media="all">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layuiadmin/dist/layuiadmin/style/login.css"
          media="all">
    ...
    <div class="layadmin-user-login-main">
        ...
        <form class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <div class="layui-form-item" style="margin-bottom: 20px;">
                ...
                <a href="${pageContext.request.contextPath}/user/forget" class="layadmin-user-jump-change layadmin-link"
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status === "0") {
                        ...
                        $('.layui-input').val("");
                        layer.msg("验证失败: " + data.message, {icon: 5, time: 3000, anim: 6});
                    }
                }
            });
            return false;
