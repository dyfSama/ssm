...
layui.define(["lodash", "axios"], function (t) {
    var n = layui.lodash, o = layui.axios;
    t("utils", {
        error: function (t) {
            console.error(t)
        }, oneOf: function (t, o) {
            ...
            o.get(t).then(function (t) {
                ...
                null !== r && n.forEach(r, function (t) {
                    ...
                    if (void 0 !== n && null != n && n.length > 0) {
                        var o = n[0], e = o.substring(1, o.length - 1), r = new RegExp(e, "g");
                        i = i.replace(r, a.randomCode())
                    }
                })
            }).catch(function (t) {
                var n = t.request, o = "读取模板出现异常，异常代码：" + n.status + "、 异常信息：" + n.statusText;
