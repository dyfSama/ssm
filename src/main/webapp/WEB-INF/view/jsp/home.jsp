...
<head>
    ...
    <link rel="Bookmark" href="${pageContext.request.contextPath}/static/H-ui.admin/favicon.ico" >
    <link rel="Shortcut Icon" href="${pageContext.request.contextPath}/static/H-ui.admin/favicon.ico" />
    <!--[if lt IE 9]>
    ...
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="welcome.html">Druid Monitor</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
           ...
           <%-- <iframe scrolling="yes" frameborder="0" src="/druid/"></iframe>--%>
            <iframe scrolling="yes" frameborder="0" src="/user/findList/"></iframe>
        </div>
    </div>
</section>
