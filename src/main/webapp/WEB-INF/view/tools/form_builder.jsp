...
<link rel="shortcut icon" href="images/favicon.ico">
    ...
    <link href="${ctxStatic}/hplus/js/plugins/bootstrap-3.3.7-dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="${ctxStatic}/hplus/css/plugins/summernote/summernote.css" rel="stylesheet">
    <link href="${ctxStatic}/hplus/css/plugins/summernote/summernote-bs3.css" rel="stylesheet">
...
<script src="${ctxStatic}/hplus/js/jquery-ui-1.10.4.min.js"></script>
<script src="${ctxStatic}/hplus/js/plugins/beautifyhtml/beautifyhtml.js"></script>
<script>
