...
<%--进度条--%>
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/layuiadmin/dist/layuiadmin/lib/nprogress/nprogress.css">


<%--所需的js--%>
<script src="${pageContext.request.contextPath}/static/layuiadmin/dist/layuiadmin/layui/layui.js"></script>
<%--进度条--%>
<script src="${pageContext.request.contextPath}/static/layuiadmin/dist/layuiadmin/lib/nprogress/nprogress.js"></script>
